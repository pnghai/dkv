    ...
    public function setUp()
    {
		...
		*/
        ...
        $this->crud->addField([  // Select2
	        'label' => "Location Type",
	        'type' => 'select2',
	        'name' => 'location_type_id', // the db column for the foreign key
	        'entity' => 'locationtype', // the method that defines the relationship in your Model
	        'attribute' => 'name', // foreign key attribute that is shown to user
	        'model' => 'App\Models\LocationType' // foreign key model
        ], 'update/create/both');
        ...
        // $this->crud->removeColumn('location_type_id'); // remove a column from the stack
        // $this->crud->removeColumns(['column_name_1', 'column_name_2']); // remove an array of columns from the stack
        $this->crud->setColumnDetails('location_type_id', [
	        // 1-n relationship
	        'label' => "Location Type", // Table column heading
	        'type' => "select",
	        'name' => 'location_type_id', // the column that contains the ID of that connected entity;
	        'entity' => 'locationtype', // the method that defines the relationship in your Model
	        'attribute' => 'name', // foreign key attribute that is shown to user
	        'model' => 'App\Models\LocationType' // foreign key model
